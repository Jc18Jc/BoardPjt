...
public class CustomUserDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        MemberSecurityDTO memberSecurityDTO = new MemberSecurityDTO(member.getMid(), member.getMpw(), member.getNickName(), member.isDel()
                , false, member.getRoleSet().stream().map(memberRole ->
